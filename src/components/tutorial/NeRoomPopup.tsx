...
export default function NeRoomPopup({ onVisit, onSkip }: NeRoomPopupProps) {
    ...
    >
      ...
      >
        <span
          ...
          style={{ background: '#D4B896', color: '#8B6914' }}
        >
          🪨 根の部屋
        </span>
        ...
        <p style={{ fontSize: 13, color: 'rgba(59,47,30,0.55)', lineHeight: 1.65, margin: '0 0 24px' }}>
          影の面を安心して話せる場所です。
          <br />
          <span style={{ fontWeight: 500, color: '#8B6914' }}>
            部屋に入るだけで、あなたの種に水が撒かれます。
          </span>
        </p>
